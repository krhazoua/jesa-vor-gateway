...
export default function Home() {
  ...
  const operationalRequests = dataError ? [] : canonicalRequests.length ? canonicalRequests : simulation.requests;
  const operationalSource = dataError ? "DATA UNAVAILABLE" : canonicalRequests.length ? "CANONICAL DB / READ-ONLY" : "ISOLATED SIMULATOR BASELINE";
